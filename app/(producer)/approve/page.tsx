...
import { useApproveCount } from "@/components/ui/ApproveCountContext";
...
export default function ApprovePage() {
  ...
  const [, setApproveCount] = useApproveCount();
  ...
  useEffect(() => {
    setApproveCount(items.length);
    return () => setApproveCount(0);
  }, [items.length, setApproveCount]);
